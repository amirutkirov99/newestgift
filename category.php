    ...
    <div class="row">
        ...
        <div class="col s12 m2 center-align cat">
            <div class="collection card">
                ...
                if ($total->num_rows > 0) {
                ?><a href="category.php?id=all" class='collection-item' >Все</a><?php
        ...
        <div class="col s12 m10 ">
            <div class="container content">
                <div class="row">
                    ...
                    if ($id_category == 'all') {
                        $queryproduct = "SELECT SQL_CALC_FOUND_ROWS id, name, price, thumbnail FROM product ORDER BY id DESC LIMIT {$start}, 16";
                    } else {
