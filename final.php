        ...
        <nav>
            <div class="nav-wrapper">
                <div class="col s12">
                    ...
                    <a href="final.php" class="breadcrumb">Спасибо</a>
                </div>
            </div>
        </nav>
    </div>
        ...
        <div class="col s12 m6">
            <div class="card center-align">
                ...
                <div class="card-content center-align">
                    <h5>Спасибо за вашу покупку!</h5>
                    <p>Уважаемый <h5 class="green-text"><?php echo"$firstname_sess". " " . "$lastname_sess";  ?></h5>ваш подарок в пути!</p>
                </div>
            </div>

            <div class="center-align">
                <a href="details.php" class="button-rounded blue btn waves-effects waves-light">Детали</a>
                <a href="index.php" class="button-rounded btn waves-effects waves-light">Главная</a>
            </div>
        </div>
        <div class="col s12 m3">
