...
if (isset($_POST['signup'])) {
  ...
  // Проверка, является ли файл изображения реальным изображением или поддельным изображением.
  ...
  // Проверить, не установлен ли $uploadOk в 0 из-за ошибки
  if ($uploadOk == 0) {
  echo "<a class='btn-large red waves-effects light-effects'>Sorry, your file was not uploaded</a><br><br>";
  // если все в порядке, попробовать загрузить файл
  } else {
