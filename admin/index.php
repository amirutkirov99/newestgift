  ...
  <div class="row">
           ...
           <div class="card horizontal">
             ...
             <div class="card-stacked">
              <div class="card-content">
                <p>Продукты, категории и заказы</p>
              </div>
               <div class="card-action">
                 <a href="infoproduct.php" class="blue-text">Открыть</a>
               </div>
             </div>
           </div>
         </div>
        ...
        <div class="card-content">
          <p>Предметы</p>
             ...
             <div class="card-action">
               <a href="products.php" class="blue-text">Открыть</a>
             </div>
             </div>
           ...
           <div class="card horizontal">
             ...
             <div class="card-stacked">
              <div class="card-content">
               ...
               <div class="card-action">
                 <a href="allusers.php" class="blue-text">Открыть</a>
               </div>
             </div>
           </div>
         </div>
    ...
    <div class="row">
         <div class="col s12 m4">
           <div class="card horizontal red lighten-1">
             <div class="card-stacked">
              <div class="card-content">
                <h5 class="white-text"><i class="material-icons left">supervisor_account</i> Общие пользователи</h5>
              </div>
               <div class="card-action">
         ...
         <div class="col s12 m4">
           <div class="card blue lighten-1 horizontal">
             <div class="card-stacked">
              <div class="card-content">
                <h5 class="white-text"><i class="material-icons left">shopping_cart</i> Предметы в корзине</h5>
              </div>
               <div class="card-action">
         ...
         <div class="col s12 m4">
           <div class="card green lighten-1 horizontal">
             <div class="card-stacked">
              <div class="card-content">
                <h5 class="white-text"><i class="material-icons left">shopping_cart</i> Общие покупки</h5>
              </div>
               <div class="card-action">
